...
local eslint = require('myLuaSetup.efm.eslint')
local prettier = require('myLuaSetup.efm.prettier')

local efm_config = os.getenv('HOME') .. '/.config/nvim/lua/myLuaSetup/efm/config.yaml'
